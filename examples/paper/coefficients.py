...
rk_full = mre.coefficients(bp_full, steps=(1, 500), dt=1, dtunit="steps", description="fully sampled")
rk_subs = mre.coefficients(bp_subs, steps=(1, 500), dt=1, dtunit="steps", description="subsampled to 2%")
rk_subz = mre.coefficients(bp_subz, steps=(1, 500), dt=1, dtunit="steps", description="subsampled to 0.1%")
