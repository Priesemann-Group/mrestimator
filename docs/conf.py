...
try:
    release = get_version("mrestimator")
...
extensions = [
    ...
    "sphinx_autodoc_typehints",  # For better type hints
    "sphinx_mdinclude",  # For better Markdown inclusion
]
...
# source_suffix is handled automatically by sphinx-mdinclude and myst_parser
...
# If you want to add custom static files, create a docs/_static directory
# and set this path again. Currently unused, so leave empty to suppress warning.
html_static_path = []
